...
dawa_enriched_locations as (
    ...
    --     on ST_Distance(s_point(home_assistant_positions.latitude_degrees, home_assistant_positions.longitude_degrees), s_point(home_assistant_positions.latitude_degrees, home_assistant_positions.longitude_degrees)) < 100
)
